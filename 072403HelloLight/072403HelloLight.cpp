...
int main()
{
	...
	//Shader
	Shader shader = Shader("helloLight.vs", "CubeObj.fs");
	Shader lightShader = Shader("helloLight.vs", "LightObj.fs");
	...
	glUniform1i(glGetUniformLocation(shader.program, "material.specularMaskTex"), 1);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(shader.program, "material.specularColor"), 0.5f, 0.5f, 0.5f);
		glUniform1f(glGetUniformLocation(shader.program, "material.gloss"), 256.0f);

		glUniform3f(glGetUniformLocation(shader.program, "lightColor"), 1.0f, 1.0f, 1.0f);
		glUniform3fv(glGetUniformLocation(shader.program, "worldlightPos"), 1, glm::value_ptr(lightPos));
		glUniform3fv(glGetUniformLocation(shader.program, "worldViewPos"), 1, glm::value_ptr(camera.Position));
