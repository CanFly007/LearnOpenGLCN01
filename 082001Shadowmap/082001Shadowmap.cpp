...
int main()
{
	...
	Shader debugDepthQuad("Scene.vs", "Scene.fs");
	...
	glUseProgram(debugDepthQuad.program);
	glUniform1i(glGetUniformLocation(debugDepthQuad.program, "floorTexture"), 0);
	...
	glUseProgram(debugDepthQuad.program);
	glUniform1i(glGetUniformLocation(debugDepthQuad.program, "shadowMap"), 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Draw Debug Scene 就是画上面生成的shadowmap到一个quad的屏幕上
