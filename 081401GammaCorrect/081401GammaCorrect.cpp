...
int main()
{
	...
	glUniform1i(glGetUniformLocation(shader.program, "floorTexture"), 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniformMatrix3fv(glGetUniformLocation(shader.program, "viewPos"), 1, GL_FALSE, glm::value_ptr(camera.Position));
